...
const BackgroundDecorations = ({ type = "hero" }: { type?: "hero" | "programs" | "newsletter" | "testimonials" }) => {
  ...
  if (type === "hero") {
    return (
      <>
        {/* Enhanced SVG at bottom left - Custom provided SVG */}
        <motion.figure 
          initial={{ x: -100, opacity: 0 }}
          animate={{ x: 0, opacity: 0.15 }}
          transition={{ duration: 1, delay: 0.5 }}
          className="absolute bottom-0 left-0 d-none d-lg-block hidden sm:block lg:opacity-20"
        >
          <svg width="822.2px" height="301.9px" viewBox="0 0 822.2 301.9" className="w-96 h-auto">
            <path 
              fill={warningColor} 
        ...
        {/* Enhanced SVG at top right - Custom provided SVG */}
        <motion.figure 
          initial={{ x: 100, opacity: 0 }}
          animate={{ x: 0, opacity: 0.15 }}
          transition={{ duration: 1, delay: 0.7 }}
          className="absolute top-0 right-0 hidden sm:block lg:opacity-20"
        >
          <svg width="822.2px" height="301.9px" viewBox="0 0 822.2 301.9" className="w-96 h-auto">
            <path 
              fill={primaryColor} 
        ...
        {/* Mobile-optimized smaller SVG for top right */}
        <motion.figure 
          initial={{ x: 50, opacity: 0 }}
          animate={{ x: 0, opacity: 0.1 }}
          transition={{ duration: 0.8, delay: 0.3 }}
          className="absolute top-0 right-0 block sm:hidden"
        >
          <svg width="400px" height="150px" viewBox="0 0 822.2 301.9" className="w-48 h-auto">
            <path 
              fill={primaryColor} 
              d="M752.5,51.9c-4.5,3.9-8.9,7.8-13.4,11.8c-51.5,45.3-104.8,92.2-171.7,101.4c-39.9,5.5-80.2-3.4-119.2-12.1 c-32.3-7.2-65.6-14.6-98.9-13.9c-66.5,1.3-128.9,35.2-175.7,64.6c-11.9,7.5-23.9,15.3-35.5,22.8c-40.5,26.4-82.5,53.8-128.4,70.7 c-2.1,0.8-4.2,1.5-6.2,2.2L0,301.9c3.3-1.1,6.7-2.3,10.2-3.5c46.1-17,88.1-44.4,128.7-70.9c11.6-7.6,23.6-15.4,35.4-22.8 c46.7-29.3,108.9-63.1,175.1-64.4c33.1-0.6,66.4,6.8,98.6,13.9c39.1,8.7,79.6,17.7,119.7,12.1C634.8,157,688.3,110,740,64.6 c4.5-3.9,9-7.9,13.4-11.8C773.8,35,797,16.4,822.2,1l-0.7-1C796.2,15.4,773,34,752.5,51.9z"
            />
        ...
        >
          <svg width="30" height="30" viewBox="0 0 30 30">
            <circle cx="15" cy="15" r="14" fill={accentColor} />
          </svg>
        </motion.figure>
        ...
        >
          <svg width="20" height="20" viewBox="0 0 20 20">
            <circle cx="10" cy="10" r="9" fill={warningColor} />
          </svg>
        </motion.figure>
      </>
    );
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden">
      {/* Enhanced Hero Section with proper padding and animations */}
      <section className="relative min-h-[90vh] sm:min-h-[85vh] flex items-center overflow-hidden p-2.5 sm:p-5 md:p-10 rounded-t-3xl mx-0 sm:mx-2 md:mx-4 mt-0 sm:mt-2 md:mt-4">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-br from-primary/90 via-primary/70 to-accent/90 opacity-95" />
        ...
        >
          ...
          >
            <motion.path 
              ...
              d="M0,80 L0,40 Q240,80 480,40 Q720,0 960,40 Q1200,80 1440,40 L1440,80 Z"
            />
          </svg>
        </motion.figure>
            ...
            <div className="w-full sm:w-10/12 md:w-9/12 lg:w-8/12 xl:w-7/12 text-white my-3 sm:mt-0">
              ...
              >
                ...
                <motion.h1 
                  ...
                  className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6 leading-tight sm:leading-tight md:leading-tight"
                  style={{ 
                    color: cssVars.primaryForeground(),
                ...
                <motion.p 
                  ...
                  className="text-lg sm:text-xl md:text-2xl mb-6 sm:mb-8 opacity-90 px-2 sm:px-0 max-w-2xl mx-auto sm:mx-0"
                  style={{ color: cssVars.primaryForeground() }}
                >
                ...
                >
                  ...
                  <Link href="/shop" className="w-full sm:w-auto">
                    ...
                    >
                      <Button 
                        size="lg"
                        className="gap-3 px-6 sm:px-8 py-6 sm:py-7 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 w-full sm:w-auto justify-center group relative overflow-hidden"
                        style={{
                  ...
                  >
                    <button
                      ...
                      className="relative group flex items-center justify-center sm:justify-start gap-3 sm:gap-4 p-3.5 sm:p-4 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 overflow-visible w-full sm:w-auto backdrop-blur-sm border border-white/20"
                      style={{
                    ...
                    >
                      ...
                      <span className="text-base sm:text-lg font-semibold">Watch Our Story</span>
                    </button>
                  </motion.div>
                </motion.div>
                ...
                <motion.div 
                  ...
                  style={{ borderColor: `${cssVars.primaryForeground()}20` }}
                >
                  <div className="flex flex-wrap justify-center sm:justify-start gap-4 sm:gap-6 md:gap-8 text-sm sm:text-base">
                    {[
                      ...
                      <motion.div
                        ...
                        whileHover={{ y: -5 }}
                        className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-xl hover:bg-white/5 transition-colors"
                      >
                        <item.icon className="w-4 h-4 sm:w-5 sm:h-5" style={{ color: cssVars.warning() }} />
                        <span style={{ color: cssVars.primaryForeground() }}>{item.text}</span>
                      </motion.div>
                    ))}
                  </div>
                </motion.div>
      ...
      {/* Rest of the components remain similar with enhanced animations */}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
            {[
              ...
              <motion.div
                ...
                className="flex flex-col items-center text-center gap-3 sm:gap-4 py-3 sm:py-4 rounded-2xl hover:shadow-lg transition-all"
                style={{
              ...
              >
                <div 
                  className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full flex items-center justify-center mb-2 sm:mb-3"
                  style={{ backgroundColor: `${cssVars.primary()}15` }}
                >
                  <badge.icon 
        ...
        <div className="container px-4 relative z-10">
          ...
          >
            ...
            <Link href="/shop" className="hidden sm:block">
              ...
              >
                <Button 
                  variant="outline" 
                  className="gap-3 rounded-full px-6 sm:px-8 py-6 text-base sm:text-lg"
                  style={{
                    borderColor: cssVars.border(),
                    color: cssVars.foreground()
                  }}
          ...
          >
            <Link href="/shop">
              <Button 
                variant="outline" 
                className="gap-3 rounded-full px-8 py-6 sm:py-7 text-lg sm:text-xl font-semibold hover:shadow-xl transition-shadow"
                style={{
                  borderColor: cssVars.border(),
                  color: cssVars.foreground(),
                  borderWidth: '2px'
        ...
        <div className="container px-4 relative z-10">
          <div className="grid md:grid-cols-2 gap-10 sm:gap-14 lg:gap-20 items-center">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="border border-border rounded-3xl p-8 bg-card shadow-2xl hover:shadow-3xl transition-shadow duration-300">
                <motion.div
                  whileHover={{ scale: 1.1 }}
                  className="w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-8"
                  style={{ backgroundColor: `${cssVars.warning()}15` }}
                >
            ...
            >
              <div className="relative h-80 sm:h-96 md:h-[500px] overflow-hidden">
                ...
                <div 
                  ...
                  style={{ 
                    background: `linear-gradient(to top, ${cssVars.foreground()} 0%, ${cssVars.foreground()}80 50%, transparent 100%)`
                  }}
                />
              </div>
              <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 md:p-10">
                ...
                <Link href="/programs">
                  ...
                  >
                    <Button 
                      size="lg"
                      className="gap-3 rounded-full px-6 sm:px-8 py-6 text-base sm:text-lg md:text-xl font-semibold group"
                      style={{
                        backgroundColor: cssVars.accent(),
                        color: cssVars.primaryForeground()
                      }}
      ...
      <motion.section
        ...
        transition={{ duration: 0.8 }}
        viewport={{ once: true }}
        className="relative py-16 sm:py-20 md:py-24 lg:py-28 overflow-hidden rounded-3xl mx-0 sm:mx-2 md:mx-4 my-12 sm:my-16 md:my-20"
        style={{ 
          backgroundColor: cssVars.secondary(),
      ...
      >
        ...
        >
          <svg width="60" height="60" viewBox="0 0 60 60">
            <circle cx="30" cy="30" r="25" fill={cssVars.primary()} />
          </svg>
        </motion.figure>
          ...
          >
            ...
            >
              <input
                ...
                className="flex-1 px-6 sm:px-8 py-5 sm:py-6 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 text-base sm:text-lg shadow-lg hover:shadow-xl transition-shadow"
                style={{
                  backgroundColor: cssVars.background(),
                  borderColor: cssVars.border(),
                  color: cssVars.foreground(),
              ...
              >
                <Button 
                  size="lg"
                  className="px-8 sm:px-10 py-5 sm:py-6 rounded-full text-base sm:text-lg md:text-xl font-semibold gap-3 w-full sm:w-auto shadow-xl hover:shadow-2xl transition-shadow"
                  style={{
                    backgroundColor: cssVars.accent(),
                    color: cssVars.primaryForeground()
                  }}
      ...
      {showVideoModal && (
        ...
        >
          <motion.div 
            ...
            className="bg-white rounded-2xl p-4 sm:p-6 max-w-4xl w-full shadow-2xl"
